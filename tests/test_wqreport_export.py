...
class WaterQualityReportIntegrationTests(unittest.TestCase):
    ...
    def test_release_version_is_1_12_1(self):
        project_root = Path(__file__).resolve().parent.parent
        ...
        self.assertEqual(tauri_config["version"], "1.12.1")
        self.assertIn('version = "1.12.1"', cargo_manifest)
        self.assertIn('version="1.12.1"', viewer_api)
