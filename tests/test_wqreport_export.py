...
class WaterQualityReportIntegrationTests(unittest.TestCase):
    ...
    def test_release_version_is_1_11_9(self):
        project_root = Path(__file__).resolve().parent.parent
        ...
        self.assertEqual(tauri_config["version"], "1.11.9")
        self.assertIn('version = "1.11.9"', cargo_manifest)
        self.assertIn('version="1.11.9"', viewer_api)
